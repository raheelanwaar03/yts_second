            ...
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                            ...
                            <div class="menu-icon">
                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        stroke="#888888" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M13.9014 4.21895L18.0869 8.40445" stroke="#888888"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </div>
                            ...
                            <div class="menu-icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        stroke-linejoin="round" />
                                    <path d="M11.9946 16.0001V12.0001" stroke="#888888" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M11.9896 8.20435H11.9996" stroke="#888888" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                    ...
                    <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="chat.html">Chat<span class="badge badge-danger badge-xs ms-1">NEW</span></a>
                            </li>
                            <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Users
                                    Manager<span class="badge badge-danger badge-xs ms-1">NEW</span></a>
                                <ul aria-expanded="false">
                            ...
                            <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Customer
                                    Manager<span class="badge badge-danger badge-xs ms-1">NEW</span></a>
                                <ul aria-expanded="false">
                            ...
                            <li><a href="contacts.html">Contacts <span
                                        class="badge badge-danger badge-xs ms-1">NEW</span></a></li>
                                ...
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    ...
                                    <g clip-path="url(#clip0_14_1294)">
                                        ...
                                        <mask id="mask0_14_1294" style="mask-type:luminance"
                                            maskUnits="userSpaceOnUse" x="6" y="0" width="21" height="20">
                                            <path
                    ...
                    <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li class="extra-menu-li">
                                ...
                                <a class="btn show-more-btn border-0" data-bs-toggle="collapse"
