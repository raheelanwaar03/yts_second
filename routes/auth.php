...
use App\Http\Controllers\RegisterationFeesController;
...
Route::get('Verification/Page', [RegisterationFeesController::class, 'verificationPage'])->name('Verification.Page');
